#!/usr/bin/env python3
"""Create a seed escrow and public commitment after Research A1 source freeze."""
...
from tsi.research_a_contract import contract_digest
...
def main() -> None:
    ...
    parser.add_argument(
        "--escrow",
        type=Path,
        default=Path("experiments/research_a_v1/confirmatory/root_seed.escrow"),
    )
    parser.add_argument(
        "--commitment",
        type=Path,
        default=Path("experiments/research_a_v1/seed_commitment.json"),
    )
    ...
    payload = {
        "status": "seed_committed_before_one_shot_execution",
