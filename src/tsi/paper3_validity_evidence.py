...
P3_VALIDITY_EVIDENCE_ID = "P3-4B-CUMULATIVE-EVIDENCE-v2"
...
def build_validity_evidence_report(
    ...
    payload: dict[str, object] = {
        ...
        "scope_boundary": (
            "held-out same-task criterion validity in the exact-state "
            "oracle-routing synthetic context family, using oracle endpoint "
            "diagnostics and frozen development-fitted predictors; not "
            "temporal prognosis, deployment-time prediction, learned routing, "
