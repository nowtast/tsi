...
P3_VALIDITY_POWER_ID = "P3-4B-VALIDITY-POWER-v2"
P3_VALIDITY_ANALYSIS_PLAN_ID = "P3-4B-VALIDITY-ANALYSIS-PLAN-v2"
POWER_SIMULATION_ID = "P3-4B-HOLM-NORMAL-SIM-v2"
...
def build_validity_power_report(
    ...
    *,
    ...
    event_rate = float(predictor_report["development_event_rate_primary"])
