...
The full nine-gate conjunction consists of graph--head identification,
...
criterion Brier, and outside-family noninferiority.  The post-freeze reporting
clarification names the other eight as inferential quantities, while
matched-head equivalence remains the separate ninth decision gate.  That gate
applies the frozen equivalence margin $0.01$ to the reported simultaneous interval;
exact functional equivalence makes its observed contrast zero when the matched
