...
간주하는 오류를 막는 것이다. Schema를 category로 보고 graph와 equation으로
제시하는 방식은 functorial data model의 표준 구성이다
\cite{spivak2012functorial,spivakwisnesky2015relational}. TSI는 instance의
codomain을 set과 function에서 finite set과 binary relation으로 바꾼다.
...
무관하다. 이는 표준 relation category이다
\cite{freydscedrov1990categories}. 완결성을 위해 elementary verification을
아래에 포함한다.
\end{proposition}
