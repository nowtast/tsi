...
an exactness theorem, not a finite-sample convergence theorem.
...
correspondence. Those additions define a different discrepancy and require
their own identifiability analysis.
...
\]
is well-defined. Direct summation shows that its $(X,Y)$ and $(Y,Z)$
marginals are the original couplings. Let $\pi_{XZ}$ be its $(X,Z)$ marginal.
