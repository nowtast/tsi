...
The finite-relation category and presented-category descent are imported from
the calculus of relations and categorical data formalisms
\cite{freydscedrov1990categories,spivak2012functorial,
spivakwisnesky2015relational}. Filtered persistence stability is imported from
persistent homology \cite{cohensteiner2007stability,chazal2009proximity};
metric--measure couplings and gluing are imported from Gromov--Wasserstein and
optimal-transport theory \cite{memoli2011gromov,peyre2019computational}; and the
rollout recurrence uses the standard Lipschitz error-propagation pattern
\cite{asadi2018lipschitz}. The TSI-specific contribution is their integration
